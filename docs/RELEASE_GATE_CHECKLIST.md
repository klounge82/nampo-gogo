...
| **REL-001-FIREBASE-F1**| Android | Firebase Google Services Gradle 플러그인 연결 및 Debug APK 빌드 검증 | **COMPLETED** | android Kotlin DSL Gradle 설정(settings.gradle.kts & app/build.gradle.kts) com.google.gms.google-services 적용 및 desugaring/compileSdk 36 연동 후 Debug APK (app-debug.apk) 빌드 100% 성공 | RELEASE-001-F1 |
