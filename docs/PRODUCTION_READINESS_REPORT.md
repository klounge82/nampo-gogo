...
6. **백엔드 실 배포 및 주소 연동**: **[COMPLETED]** Railway HTTPS Backend 최초 배포 및 Flutter 앱 API 연결 완료. UserAuth 모델 테이블명 정합 완료 후 회원가입·로그인·me조회·계정탈퇴 API 스모크 테스트 100% 통과 (단, stores 0건으로 Seed Data 투입 필요).
