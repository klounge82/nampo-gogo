...
void main() {
  group('HOTFIX-008: Reservation Null-safe Parsing & UI Tests', () {
    test('1. Dashboard widget registry marks all 4 reservation cards available', () {
      ...
      final completedWidget = DashboardWidgetRegistry.businessWidgets.firstWhere(
        (w) => w.widgetKey == 'completed_reservations',
      );
      final settingsWidget = DashboardWidgetRegistry.businessWidgets.firstWhere(
        (w) => w.widgetKey == 'reservation_settings',
      );
    ...
    test('2. BusinessReservationsScreen instantiates safely with null-safe defaults', () {
