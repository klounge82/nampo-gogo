...
void main() {
  testWidgets('SpatialGeometryEditorScreen without initialPoints starts EMPTY', (WidgetTester tester) async {
    ...
    // Verify SpatialGeometryEditorScreen is present
