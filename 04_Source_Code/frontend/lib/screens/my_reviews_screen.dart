...
class _MyReviewsScreenState extends State<MyReviewsScreen> {
  ...
  void _confirmDelete(String reviewId) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('리뷰 삭제', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.secondary)),
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('삭제하기', style: TextStyle(color: AppColors.secondary, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('내가 작성한 리뷰', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(onPressed: _loadMyReviews, child: const Text('다시 시도')),
                    ],
                  ),
                )
              : _reviews.isEmpty
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              review.content,
              style: const TextStyle(fontSize: 13.0, color: AppColors.textPrimary, height: 1.4),
            ),
            const SizedBox(height: 16.0),
