...
class ModuleRegistry {
  ...
  static const List<FeatureModule> businessModules = [
    ...
    FeatureModule(
      ...
      allowedModes: ['BUSINESS'],
      requiredCapabilities: ['reservation.own.manage'],
      navigationPosition: 2,
    ),
    FeatureModule(
      ...
      allowedModes: ['BUSINESS'],
      requiredCapabilities: ['store.own.update'],
      navigationPosition: 3,
    ),
    FeatureModule(
      ...
      allowedModes: ['BUSINESS'],
      requiredCapabilities: ['review.own.read'],
      navigationPosition: 4,
    ),
    FeatureModule(
      ...
      allowedModes: ['BUSINESS'],
      requiredCapabilities: ['product.own.manage'],
      enabled: false,
      comingSoon: true,
      navigationPosition: 5,
    ),
