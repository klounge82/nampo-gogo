...
class Store(Base):
    ...
    address_ja = Column(String(255), nullable=True)
    address_zh = Column(String(255), nullable=True)
    short_description = Column(Text, nullable=True)
    short_description_en = Column(Text, nullable=True)
    short_description_ja = Column(Text, nullable=True)
    short_description_zh = Column(Text, nullable=True)
...
class Mission(Base):
    ...
    title_ja = Column(String(100), nullable=True)
    title_zh = Column(String(100), nullable=True)
    description_en = Column(Text, nullable=True)
    description_ja = Column(Text, nullable=True)
    description_zh = Column(Text, nullable=True)
